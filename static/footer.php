...
<div id="contact-home-section">
      <div class="container">
        <h2>Reach out!</h2>
        <p><a href="contact.php"><i class="fa fa-envelope-open-o" aria-hidden="true"></i> Contact the Dr.!</a></p>
      </div>
</div>
  ...
  <footer>
    ...
    <ul id="accordion-footer">
      <li><img class="logo_footer" src="assets/img/FOOTER-LOGO.png" alt="Dr. Planter"></li>
      <li>
